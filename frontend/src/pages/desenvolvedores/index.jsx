...
export default function Desenvolvedores() {
 ...
 <header className="front-header">
      <div className="logo-area">
        <img src="logotome.png" alt="DreamCoders Logo" className="logo-img" />
      </div>
      ...
      <nav className="nav-links">
        ...
        <section className="front-servicos">
          ...
          <div className="front-servicos-container">
            <div className="front-card">
              ...
              <img src="code.png" alt="Web Sites" />
            ...
            <div className="front-card">
              ...
              <img src="roboia.png" alt="Inteligência Artificial" />
        ...
        <section className="front-devs">
          ...
          <div className="dev-card">
            ...
            <img src="vin.png" alt="Vinícius Freire" />
          </div>
          ...
          <div className="dev-card">
            ...
            <img src="joao.jpg" alt="João Vitor" />
          </div>
        </section>
